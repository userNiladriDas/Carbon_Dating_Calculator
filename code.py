...
def graphPlot():
    ...
    if (p1 != -1 and k1 != -1 and r1 != -1 and t1 != -1):
...
# plt.xlabel("Time(years)")
# plt.ylabel("Amount of c-14 remaining(%)")
# plt.annotate('This is the decay state of the sample',xytext=(t+3000,p+15),xy=(t,p),arrowprops={'facecolor':'black'})
# plt.title("Decay of C-14")
# plt.show()
# print("The age of your sample is : \n", np.round(t),"years")


root.mainloop()# Import Module
import tkinter as tk
from tkinter.ttk import *
import numpy as np
import matplotlib.pyplot as plt
